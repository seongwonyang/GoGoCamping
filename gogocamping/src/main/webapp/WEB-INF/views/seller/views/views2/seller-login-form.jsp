					...
					<div class="hero__search">
                        <div class="#">
                        	...
                        	<form action="/seller/login" method="post">
								...
								<a href="/seller/registerForm"><button type="button" id="registerSellerBtn" name="registerSellerBtn" class="site-btn" style="width: 135px; height: 50px; background-color: #065E93; border-radius: 10px;">회원가입</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="/seller/findSellerIdForm"><button type="button" id="findIdBtn" name="findIdBtn" class="site-btn" style="width: 135px; height: 50px; background-color: #065E93; border-radius: 10px;">아이디 찾기</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="/seller/findSellerPwForm"><button type="button" id="findPwBtn" name="findPwBtn" class="site-btn" style="width: 135px; height: 50px; background-color: #065E93; border-radius: 10px;">비밀번호 찾기</button></a><br><br>
                        	</form>
						</div>
					</div>
				</div>
