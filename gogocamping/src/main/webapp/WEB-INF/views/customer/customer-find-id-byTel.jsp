            ...
            <div class="col-lg-9 mx-auto text-center mt-7 mb-5">
               <div class="hero__search">
                        <div class="#">
                           ...
                           <form action="/customer/getCustomerIdByTel" method="post">
                        		...
                        		<input type="text" id="customerTel" name="customerTel" placeholder="  휴대전화"  style="width: 444px; height: 50px; border: 2.5px solid #245207; border-radius: 10px;"><br><br>
