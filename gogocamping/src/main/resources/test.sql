...
register_admin number not null 
);
-- 1-3.소비자(customer)
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
--회원정보 수정
update CUSTOMER set customer_email='a', customer_tel='010-3333-4444', customer_post_number='123456', customer_address='ㅎㅎ', customer_detailed_address='ff' where customer_id='juhyung3655'