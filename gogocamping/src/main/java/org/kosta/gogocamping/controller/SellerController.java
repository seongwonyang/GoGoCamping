	...
	public String registerSeller(String sellerId, String sellerPassword, String sellerName, String sellerEmail,
		...
		try {
			if (!logoImgFile.isEmpty()) {
				...
				SellerVO sellerVO = new SellerVO(sellerId, sellerPassword, sellerName, sellerEmail, sellerTel,
						businessNumber, brand, logoImgFile.getOriginalFilename(), storedFileName, sellerPostNumber,
						sellerAddress, sellerDetailedAddress, 0);
